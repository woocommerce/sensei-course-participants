...
class Sensei_Course_Participants_Dependency_Checker {
	...
	public static function add_sensei_notice() {
		...
		$message = sprintf( __( '<strong>Sensei Course Participants</strong> requires the plugin <strong>Sensei</strong> (minimum version: <strong>%1$s</strong>) is installed and activated.', 'sensei-course-participants' ), self::MINIMUM_SENSEI_VERSION );
		echo '<div class="error"><p>';
		echo wp_kses( $message, array( 'strong' => array() ) );
		echo '</p></div>';
	}
